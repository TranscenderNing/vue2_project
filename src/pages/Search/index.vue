  ...
  <div>
    ...
    <div class="main">
      <div class="py-container">
        ...
        <!--selector-->
        <SearchSelector @getTradeMarkInfo="handleTradeMark" @getAttrInfo="handleAttrInfo" />
...
export default {
  ...
  methods:{
    ...
    handleTradeMark(trademark){
        ...
        console.log('父组件收到了子组件的信息',trademark)
        this.getData()

    },
    handleAttrInfo(attr,attrdValue){
        console.log('父组件收到了子组件的 属性信息',attr,attrdValue)
        let props = `${attr.attrId}:${attrdValue}:${attr.attrName}`
